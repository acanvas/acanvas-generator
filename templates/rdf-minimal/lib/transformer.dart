...
class InjectProperties extends Transformer {
  ...
  InjectProperties.asPlugin(this._settings) {
    ...
    if ("@project.debug@" == "false" ? false : true) {
      ...
      new File('config/debug/public.properties')
          .copySync('web/config/project.properties');
      ...
      new File('config/release/public.properties')
          .copySync('web/config/project.properties');
    ...
    _files.forEach((String path) {
      ...
      //parse properties
      KeyValuePropertiesParser propertiesParser =
          new KeyValuePropertiesParser();
  ...
  Future apply(Transform transform) async {
    ...
    transform
        .addOutput(new Asset.fromString(transform.primaryInput.id, newContent));
  }
