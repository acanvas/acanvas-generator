  ...
  void createBodies() {
    ...
    for (i = 0; i < 10; i++) {
      createBox(
          ...
          spanWidth / 2 + 0 + new Random().nextDouble() * 0.02 - 0.01,
          spanHeight - 60 - i * 60,
          density: 1.0,
          friction: 0.5,
          restitution: 0.1,
    ...
    for (i = 0; i < 10; i++) {
      createBox(
          ...
          60.0,
          MdDimensions.HEIGHT_BUTTON / 2,
          spanWidth / 2 + 140 + new Random().nextDouble() * 0.02 - 0.01,
          spanHeight - 60 - i * 60,
          density: 1.0,
          friction: 0.5,
          restitution: 0.1,
    ...
    for (i = 0; i < 10; i++) {
      createBox(
          ...
          60.0,
          MdDimensions.HEIGHT_BUTTON / 2,
          spanWidth / 2 + 280 + new Random().nextDouble() * 0.02 - 0.01,
          spanHeight - 60 - i * 60,
          density: 1.0,
          friction: 0.5,
          restitution: 0.1,
    ...
    createShape("ramp", vxs, 0.0, (spanWidth / 2).round(),
        type: b2Body.b2_staticBody, density: 0.0);
  }
}
