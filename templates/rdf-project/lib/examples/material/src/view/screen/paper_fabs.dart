...
class MdFabs extends AbstractReflowScreen {
  ...
  void init({Map<String, String> params: null}) {
    ...
    wrap01.addChild(
        new MdFab(MdIcon.white(MdIconSet.create), bgColor: Theme.COLOR_BASE));
    wrap01.addChild(
        new MdFab(MdIcon.white(MdIconSet.favorite), bgColor: Theme.COLOR_BASE));
    ...
    wrap03.addChild(
        new MdFab(MdIcon.black(MdIconSet.favorite), bgColor: Theme.COLOR_BASE));
