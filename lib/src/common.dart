...
final RegExp _binaryFileTypes = new RegExp(r'\.(mp3|ogg|zip|gaf|webp|fnt|jpe?g|png|gif|ico|svg|ttf|eot|woff|woff2)$', caseSensitive: false);
...
Future<List<TemplateFile>> decodeConcanenatedData(List<String> data, String pack) async {
  ...
  for (int i = 0; i < data.length; i++) {
    ...
    myResource = new Resource('package:rockdot_generator/templates/${pack}/${path}');
