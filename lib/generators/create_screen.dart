...
const String SCREEN_INSERTION_PLACEHOLDER =
    "// ## SCREEN INSERTION PLACEHOLDER - DO NOT REMOVE ## //";
const String SCREEN_PROPERTIES_PLACEHOLDER =
    "## SCREEN INSERTION PLACEHOLDER - DO NOT REMOVE ##";
...
void main(List<String> args) {
  ...
  if (screenNameCamelCase == DEFAULT_SCREEN_NAME) {
    print(
        "Well, at least provide the --name of the Screen you want to add, will you?");
    exit(1);
  }
...
''';
  ...
  String path = (screenRoot != DIR_LIB)
      ? "$screenRoot/$DIR_PROPERTIES/en.properties"
