...
const String TEMPLATE_COMMAND_FILE = "create_command.dart.tpl";
const String PACKAGE_REPLACE_STRING = "@package@";
const String COMMAND_REPLACE_STRING = "@command@";

const String COMMAND_INSERTION_PLACEHOLDER =
...
void main(List<String> args) {
  ...
  if (commandNameCamelCase == DEFAULT_COMMAND_NAME) {
    print(
        "Well, at least provide the --name of the Command (in CamelCase) you want to add, will you?");
    exit(1);
  }
