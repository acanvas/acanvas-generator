...
class Assets {
  ...
  static Future load() async {
    _singleton.mgr.addBitmapData("acanvas_logo_wide_bnw",
        "assets/autoload/acanvas-logo-wide-bnw@1x.png");
    _singleton.mgr.addBitmapData(
        "displacement_bubble", "assets/autoload/displacement_bubble.png");
    _singleton.mgr.addBitmapData("acanvas_logotype_white",
        "assets/autoload/acanvas-logotype-white@1x.png");
