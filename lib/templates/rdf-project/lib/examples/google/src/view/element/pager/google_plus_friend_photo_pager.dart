...
class GooglePlusFriendPhotoPager extends AbstractPhotoPager {
  ...
  GooglePlusFriendPhotoPager(
      this.dataCommand, String labelPrev, String labelNext, String labelEmpty)
  ...
  setupProxy() {
    ...
    pagerProxy.dataRetrieveCommand =
        dataCommand; //applicationContext.getObject(UGCEvents.ITEMS_FILTER);
    pagerProxy.dataRetrieveCommandVO =
        new DataRetrieveVO(DATA_PAGESIZE, nextToken: "");
  ...
  BehaveSprite getPagerItem(dynamic vo) {
    String url =
        (vo as Person).image.url.replaceAll(r"sz=50", "sz=$listItemWidth");
