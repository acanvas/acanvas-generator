...
class MoppiFlowerExample extends AbstractScreen {
  ...
  Future load({Map params: null}) async {
    ...
    _resourceManager.addBitmapData(
        "flower_1", "assets/moppiflower/test_flower1.png");
    _resourceManager.addBitmapData(
        "flower_2", "assets/moppiflower/test_flower2.png");
    _resourceManager.addBitmapData("leaf", "assets/moppiflower/test_leaf.png");
    _resourceManager.addBitmapData(
        "overlay", "assets/moppiflower/test_overlay.jpg");
