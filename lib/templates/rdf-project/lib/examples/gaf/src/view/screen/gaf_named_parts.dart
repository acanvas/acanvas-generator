...
class GafNamedParts extends AbstractScreen {
  ...
  Future load({Map params: null}) async {
    ...
    _gafAsset2 =
        await GAFAsset.load('assets/gaf/robot_nesting/robot.gaf', 1, 1);
    onLoadComplete();
  }
  ...
  void init({Map<String, String> params: null}) {
    ...
    var textFormat =
        new TextFormat("Roboto, Helvetica, Arial", 24, Color.White);
  ...
  void refresh() {
    ...
    _gafMovieClip1.scaleX =
        _gafMovieClip1.scaleY = spanWidth / _originalWidth / 2;

    _gafMovieClip1.x = _gafMovieClip1.width / 2 + 10;
    _gafMovieClip1.y = spanHeight - _gafMovieClip1.height / 2;

    _gafMovieClip2.scaleX =
        _gafMovieClip2.scaleY = spanWidth / _originalWidth / 2;
