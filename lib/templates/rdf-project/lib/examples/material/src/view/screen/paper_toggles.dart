...
class MdToggles extends AbstractReflowScreen {
  ...
  void init({Map<String, String> params: null}) {
    ...
    wrap02.addChild(
        new MdToggleButton(label: getProperty("button01"))..disable());
    wrap02.addChild(
        new MdToggleButton(label: getProperty("button02"))..disable());
    wrap02.addChild(
        new MdToggleButton(label: getProperty("button03"))..disable());
    wrap02.addChild(
        new MdToggleButton(label: getProperty("button04"))..disable());
    wrap02.addChild(
        new MdToggleButton(label: getProperty("button05"))..disable());
    wrap02.span(310, 470);
