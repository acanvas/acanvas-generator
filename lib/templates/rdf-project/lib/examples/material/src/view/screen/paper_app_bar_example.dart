...
class MdAppBarExample extends AbstractReflowScreen {
  ...
  void init({Map<String, String> params: null}) {
    ...
    appBar02.addToTL(new MdIconButton(
        MdIcon.color(MdIconSet.menu, Theme.MD_BUTTON_ICON_COLOR),
        rippleColor: Theme.MD_BUTTON_COLOR)
      ..opacity = .75);
    appBar02.addHeadline(Theme.getHeadline("Headline", color: Colors.WHITE));
    appBar02.addToTR(new MdIconButton(
        MdIcon.color(MdIconSet.account_box, Theme.MD_BUTTON_ICON_COLOR),
        rippleColor: Theme.MD_BUTTON_COLOR)
      ..opacity = .75);
    appBar02.addToTR(new MdIconButton(
        MdIcon.color(MdIconSet.accessibility, Theme.MD_BUTTON_ICON_COLOR),
        rippleColor: Theme.MD_BUTTON_COLOR)
      ..opacity = .75);
    appBar02.addToTR(new MdIconButton(
        MdIcon.color(MdIconSet.arrow_drop_down, Theme.MD_BUTTON_ICON_COLOR),
        rippleColor: Theme.MD_BUTTON_COLOR)
      ..opacity = .75);
    ...
    appBar03.addToTL(new MdIconButton(MdIcon.black(MdIconSet.menu),
        rippleColor: Theme.COLOR_TRIAD_BLUE));
