...
class AbstractBox2dScreen extends AbstractScreen with MBox2dHelper {
  ...
  void _initFrame() {
    createBox("wallL", 50, spanHeight / 2, -50, spanHeight / 2,
        type: b2Body.b2_staticBody, density: 3.0);
    createBox("wallR", 50, spanHeight / 2, spanWidth + 50, spanHeight / 2,
        type: b2Body.b2_staticBody, density: 3.0);
    createBox("wallT", spanWidth / 2, 50, spanWidth / 2, -50,
        type: b2Body.b2_staticBody, density: 3.0);
    createBox("wallB", spanWidth / 2, 50, spanWidth / 2, spanHeight + 50,
        type: b2Body.b2_staticBody, density: 3.0);
  }
