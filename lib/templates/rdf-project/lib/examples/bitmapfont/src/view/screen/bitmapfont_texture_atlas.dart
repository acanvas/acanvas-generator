...
aliquyam erat, sed diam voluptua.""";
  ...
  Future load({Map params: null}) async {
    ...
    _resourceManager.addTextureAtlas(
        "atlas", "assets/bitmapfont/common/images/font_atlas.json");
    _resourceManager.addTextFile(
        "fnt1", "assets/bitmapfont/common/fonts/fnt/Luckiest_Guy.fnt");
    _resourceManager.addTextFile(
        "fnt2", "assets/bitmapfont/common/fonts/fnt/Fascinate_Inline.fnt");
    _resourceManager.addTextFile(
        "fnt3", "assets/bitmapfont/common/fonts/fnt/Sarina.fnt");
    _resourceManager.addTextFile(
        "fnt4", "assets/bitmapfont/common/fonts/fnt/Sigmar_One.fnt");
