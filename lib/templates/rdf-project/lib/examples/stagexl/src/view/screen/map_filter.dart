...
class MapFilter extends AbstractScreen {
  ...
  Future load({Map params: null}) async {
    ...
    _resourceManager.addBitmapData("guy_pixels",
        "assets/stagexl/normal_map_filter/character-with-si-logo.png");
    _resourceManager.addBitmapData("guy_normal",
        "assets/stagexl/normal_map_filter/character-with-si-logo_n.png");
  ...
  void init({Map<String, String> params: null}) {
    ...
    _textField.text =
        "Normal Map created with www.codeandweb.com/spriteilluminator";
