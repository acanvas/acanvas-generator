...
class Dimensions{
      ...
      static int get WIDTH_CONTENT => min(WIDTH_STAGE - X_PAGES, WIDTH_MAX - X_PAGES);
      ...
      static int get WIDTH_STAGE => min(WIDTH_MAX, max(WIDTH_MIN, RdConstants.getStage().stageWidth));
      static int get HEIGHT_STAGE => min(HEIGHT_MAX, max(HEIGHT_MIN, RdConstants.getStage().stageHeight));
