  ...
  void init({Map<String, String> params: null}) {
    ...
    _wrap01.addChild(Theme.getButton(label: getProperty("invite.button"))
      ..submitEvent = new RdSignal(
          ...
          new VOFBInvite(
              getProperty("invite.dialog.title"), getProperty("invite.dialog.copy"), getProperty("invite.payload"))));
    _wrap01.addChild(Theme.getButton(label: getProperty("share.button"))
      ..submitEvent = new RdSignal(
          FBEvents.PROMPT_SHARE,
          new VOFBShare(VOFBShare.TYPE_SHARE_OG, getProperty("share.message"), getProperty("share.link"),
              getProperty("share.image"))));
    ...
    _wrap01.addChild(Theme.getButton(label: getProperty("upload.button"))
      ..submitEvent = new RdSignal(
          ...
          new VOFBPhotoUpload(getProperty("upload.filename"), firstAlbum.id,
              bmd: Assets.rockdot, message: getProperty("upload.message"))));
  }
}
