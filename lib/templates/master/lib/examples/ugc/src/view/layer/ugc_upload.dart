...
class UGCUpload extends UGCAbstractLayer {
  ...
  void init({Map<String, String> params: null}) {
    ...
    onInitComplete();
    new RdSignal(IOEvents.FILE_SELECT_CREATE, null, _onSelectCreated).dispatch();
  }

  _onSelectCreated(DivElement div) {
    _inputDiv = div;
    refresh();
    new RdSignal(IOEvents.FILE_SELECT_OBSERVE, new IOImageFileObserveVO(), _onFilesSelected).dispatch();
  }
  ...
  _onFilesSelected(BitmapData bmd) {
    ...
    _button.submitEvent =
        new RdSignal(StateEvents.ADDRESS_SET, getProperty("${UGCExampleScreenIDs.UGC_LAYER_REGISTER}.url", true));
