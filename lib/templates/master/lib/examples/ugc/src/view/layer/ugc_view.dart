...
class UGCView extends UGCAbstractLayer {
  ...
  void init({Map<String, String> params: null}) {
    ...
    _pic = new ImageSprite()
      ..href = getProperty("project.host.download", true) + "/" + (_ugcModel.currentItemDAO.type_dao as UGCImageItemDTO).url_big
      ..addEventListener(Event.COMPLETE, _onImageLoadComplete);
    _reflow.addChild(_pic);

    _reflow.addChild(new MdButton(getProperty("button.close"), preset: MdButton.PRESET_GREEN, shadow: false)
