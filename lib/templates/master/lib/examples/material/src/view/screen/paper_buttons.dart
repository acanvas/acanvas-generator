...
class MdButtons extends AbstractReflowScreen {
  ...
  void init({Map params: null}) {
    ...
    wrap01.addChild(
        new MdButton(getProperty("button01"), fontColor: Colors.BLACK, shadow: false, bgColor: MdColor.TRANSPARENT));
    wrap01.addChild(new MdButton(getProperty("button02"),
        fontColor: Theme.COLOR_BASE, shadow: false, bgColor: MdColor.TRANSPARENT));
    wrap01.addChild(new MdButton(getProperty("button03"),
        fontColor: Colors.GREY_LIGHT, shadow: false, ripple: false, bgColor: Colors.GREY_MIDDLE));
    wrap01.addChild(new MdButton(getProperty("button04"),
        fontColor: Colors.BLACK, shadow: false, ripple: false, bgColor: MdColor.TRANSPARENT));
    ...
    wrap01.addChild(new MdButton(getProperty("button06"),
        fontColor: Colors.BLACK, shadow: false, bgColor: MdColor.TRANSPARENT, icon: MdIcon.black(MdIconSet.close)));
    wrap01.span(180, 450);

    MdWrap wrap02 = Theme.getWrap(label: getProperty("col02"), align: AlignH.CENTER);
    wrap02
        .addChild(new MdButton(getProperty("button01"), fontColor: Colors.BLACK, shadow: true, bgColor: MdColor.WHITE));
    wrap02.addChild(
        new MdButton(getProperty("button02"), fontColor: Colors.WHITE, shadow: true, bgColor: Theme.COLOR_BASE));
    wrap02.addChild(new MdButton(getProperty("button03"),
        fontColor: Colors.GREY_LIGHT, shadow: false, ripple: false, bgColor: Colors.GREY_MIDDLE));
    wrap02.addChild(new MdButton(getProperty("button04"),
        fontColor: Colors.BLACK, shadow: true, ripple: false, bgColor: MdColor.WHITE));
    ...
    wrap02.addChild(new MdButton(getProperty("button06"),
        fontColor: Colors.BLACK, shadow: true, bgColor: MdColor.WHITE, icon: MdIcon.black(MdIconSet.close)));
    wrap02.span(180, 450);
    ...
    wrap03.addChild(
        new MdButton(getProperty("button01"), fontColor: Colors.BLACK, shadow: false, bgColor: MdColor.TRANSPARENT)
          ..selfSelect = true);
    wrap03.addChild(new MdButton(getProperty("button04"), fontColor: Colors.BLACK, shadow: true, bgColor: MdColor.WHITE)
      ..selfSelect = true);
    wrap03.addChild(new MdButton(getProperty("button02"),
        fontColor: Theme.HEADLINE_COLOR,
        shadow: false,
        ripple: false,
        bgColor: Theme.COLOR_TRIAD_GREEN)..selfSelect = true);
    wrap03.addChild(
        new MdButton(getProperty("button02"), fontColor: Colors.WHITE, shadow: true, bgColor: Theme.COLOR_TRIAD_GREEN)
          ..selfSelect = true);
    wrap03.addChild(new MdButton(getProperty("button05"),
        fontColor: Theme.COLOR_BASE,
        shadow: false,
        bgColor: MdColor.TRANSPARENT,
        icon: MdIcon.color(MdIconSet.done, Theme.COLOR_BASE))..selfSelect = true);
    wrap03.addChild(new MdButton(getProperty("button06"),
        fontColor: Colors.BLACK,
        shadow: false,
        bgColor: MdColor.TRANSPARENT,
        icon: MdIcon.black(MdIconSet.close))..selfSelect = true);
    wrap03.span(180, 450);

    MdWrap wrap04 = Theme.getWrap(label: getProperty("col04"), align: AlignH.CENTER);
