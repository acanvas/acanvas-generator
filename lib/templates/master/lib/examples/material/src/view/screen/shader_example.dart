...
class ShaderExample extends AbstractReflowScreen {
  ...
  void init({Map params: null}) {
    ...
    MdButton button1 = new MdButton(getProperty("button01"), preset: MdButton.PRESET_WHITE)
      ..submitCallback = (b) {
    ...
    MdButton button2 = new MdButton(getProperty("button02"), preset: MdButton.PRESET_GREY)
      ..submitCallback = (b) {
    ...
    MdButton button3 = new MdButton(getProperty("button03"), bgColor: Theme.COLOR_BASE, fontColor: Colors.WHITE)
      ..submitCallback = (b) {
    ...
    MdButton button4 = new MdButton(getProperty("button04"), preset: MdButton.PRESET_GREEN)
      ..submitCallback = (b) {
        var bitmapData = null;
        ...
        _hbox6.filters = [new DisplacementMapFilter(bitmapData, matrix, 100, 100)];
  ...
  void _animate() {
    ...
    Rd.STAGE.juggler.addTween(_hbox6, 15)
      ...
      ..onUpdate = () {
        if (_hbox6.filters.length > 0 && _hbox6.filters[0] is DisplacementMapFilter) {
          _time += 0.05;
          (_hbox6.filters[0] as DisplacementMapFilter).matrix.translate(cos(_time) * 12, 0.0);
        }
      };
  }
