...
class MdTexts extends AbstractReflowScreen {
  ...
  void init({Map<String, String> params: null}) {
    ...
    wrap01.addChild(new MdInput(getProperty("input03"), keyboard: Rd.MOBILE, floating: false));
    wrap01.addChild(new MdInput(getProperty("input04"), keyboard: Rd.MOBILE, floating: true));
    ...
    wrap03.addChild(new MdInput(getProperty("input06"),
        required: getProperty("input06.required"), keyboard: Rd.MOBILE, floating: true));
    wrap03.addChild(new MdInput(getProperty("input06"),
        required: getProperty("input06.required"), keyboard: Rd.MOBILE, floating: true));
