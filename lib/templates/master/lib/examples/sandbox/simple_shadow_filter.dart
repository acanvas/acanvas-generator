...
class CloudFilter extends BitmapFilter {
  ...
  BitmapFilter clone() {
    return new SimpleShadowFilter(distance, angle, color, blurX, blurY, quality, knockout, hideObject);
  }
  ...
  void apply(BitmapData bitmapData, [Rectangle<int> rectangle]) {
    RenderTextureQuad renderTextureQuad =
        rectangle == null ? bitmapData.renderTextureQuad : bitmapData.renderTextureQuad.cut(rectangle);
...
class DropShadowFilterProgram extends RenderProgram {
  ...
  void renderDropShadowFilterQuad(RenderState renderState, RenderTextureQuad renderTextureQuad, int color, num alpha,
      num shiftX, num shiftY, num radiusX, num radiusY) {
