...
class SoundAnalyzer {
  ...
  void _start() {
    ...
    /*
      ...
      Test, geht auch nicht in Dartium:
      var osc = WebAudioApiMixer.audioContext.createOscillator();
      osc.frequency.value = 1000;
      osc.start();
      osc.connectNode(_analyzer);
      _analyzer.connectNode(WebAudioApiMixer.audioContext.destination);


      Sound:
      (_soundChannel as WebAudioApiSoundChannel).sourceNode

      Gain:
      SoundMixer.webAudioApiMixer.inputNode

      Dest:
      WebAudioApiMixer.audioContext.destination
