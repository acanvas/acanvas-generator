...
class SpineTextureAtlas extends AbstractScreen {
  ...
  Future<bool> load({Map params: null}) async {
    ...
    _resourceManager.addTextFile("goblins-mesh-spine", "assets/spine/texture-atlas/goblins-mesh.json");
    _resourceManager.addTextFile("goblins-mesh-atlas", "assets/spine/texture-atlas/goblins-mesh.atlas");
    _resourceManager.addTextFile("hero-mesh-spine", "assets/spine/texture-atlas/hero-mesh.json");
    _resourceManager.addTextFile("hero-mesh-atlas", "assets/spine/texture-atlas/hero-mesh.atlas");
    _resourceManager.addTextFile("raptor-spine", "assets/spine/texture-atlas/raptor.json");
    _resourceManager.addTextFile("raptor-atlas", "assets/spine/texture-atlas/raptor.atlas");
    _resourceManager.addTextFile("speedy-spine", "assets/spine/texture-atlas/speedy.json");
    _resourceManager.addTextFile("speedy-atlas", "assets/spine/texture-atlas/speedy.atlas");
    _resourceManager.addTextFile("spineboy-hoverboard-spine", "assets/spine/texture-atlas/spineboy-hover.json");
  ...
  void init({Map<String, String> params: null}) {
    ...
    for (var name in names) {
      ...
      var bitmapData = _resourceManager.getTextureAtlas("combined").getBitmapData(name);
      var spine = _resourceManager.getTextFile("$name-spine");
      var atlas = _resourceManager.getTextFile("$name-atlas");
      TextureAtlas.fromBitmapData(bitmapData, atlas, TextureAtlasFormat.LIBGDX).then((textureAtlas) {
