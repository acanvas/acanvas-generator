...
class MdPhysics extends AbstractBox2dScreen {
  ...
  void init({Map params: null}) {
    ...
    _cycleButton =
        new MdButton(getProperty("button01"), fontColor: MdColor.WHITE, shadow: true, bgColor: Theme.COLOR_BASE);
  ...
  void _setActiveExample(int idx) {
    ...
    switch (_activeExampleIndex) {
      case 0:
        activeExample = new Buoyancy(m_world, m_physScale, spanWidth, spanHeight);
        break;
      case 1:
        activeExample = new Ragdolls(m_world, m_physScale, spanWidth, spanHeight);
        break;
      case 2:
  ...
  @override
  void refresh() {
    _cycleButton.x = (spanWidth - _cycleButton.spanWidth - Dimensions.SPACER).round();
