...
class HomeMoreBox extends RockdotBoxSprite {
    ...
    HomeMoreBox(this.id) : super() {
        ...
        wrap01 = new MdWrap(Theme.getHeadline(getProperty("headline").toUpperCase(), size: 18),
            align: AlignH.LEFT, panelColor: Theme.MD_BUTTON_COLOR, spacing: 0, padding: 5, bgColor: Color.White)
