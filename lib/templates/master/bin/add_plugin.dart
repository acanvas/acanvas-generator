...
const String PLUGIN_INSERTION_PLACEHOLDER = "// ## PLUGIN INSERTION PLACEHOLDER - DO NOT REMOVE ## //";
...
String _createFile(String sourcePath) {
  String dirName = dirname(sourcePath).replaceFirst(new RegExp(TEMPLATE_DIR), '');
